...
export interface SiteSettings {
  ...
  logoUrl: string; primaryColor: string; arcLogoUrl: string; usycLogoUrl: string;
  usdcLogoUrl: string; eurcLogoUrl: string; cirBTCLogoUrl: string;
}

const DEFAULTS: SiteSettings = {
  siteName: "GlowIDE", siteTagline: "AI-Powered Web3 IDE",
  siteDescription: "Build smarter on Web3", logoUrl: "", arcLogoUrl: "", usycLogoUrl: "",
  primaryColor: "#7c3aed",
    ...
    fetch("/api/admin/public-settings")
      ...
      .then(d => {
        _cache = {
          ...
          logoUrl:       d.logo_url         || "",
          arcLogoUrl:    d.arc_logo_url      || "",
          usycLogoUrl:   d.usyc_logo_url     || "",
